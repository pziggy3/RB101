...
def idf(term, documents)
  ...
  # We need to perform FLOAT DIVISION, not INTEGER DIVISION - use fdiv
...
puts tfidf("some", document3, documents) # ~ 0.4s



# We need to perform FLOAT DIVISION, not INTEGER DIVISION - use fdiv in the `idf` method
# We need to do this because we're dividing 2 integers in that method, but want to get a decimal answer